    ...
    <Card>
        <div slot="title">
            <div class="edit-head">
                ...
                <div class="head-name">回复家校留言</div>
                <span></span>
        ...
        <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
            <FormItem label="留言内容" prop="content">
                <Input v-model="form.content" readonly type="textarea" :rows="4" maxlength="240" show-word-limit placeholder="请输入留言内容..." style="width:570px" />
            </FormItem>
            ...
            <FormItem label="回复内容" prop="replyContent">
                <Input v-model="form.replyContent" clearable type="textarea" :rows="4" maxlength="240" show-word-limit placeholder="请输入回复内容..." style="width:570px" />
            </FormItem>
