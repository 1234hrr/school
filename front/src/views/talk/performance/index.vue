            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="title">
                        <Select v-model="searchForm.title" placeholder="行为类型" clearable style="width: 150px">
                            <Option value="行为类型A">行为类型A</Option>
                            <Option value="行为类型B">行为类型B</Option>
                        </Select>
                    </Form-item>
                    <Form-item label="" prop="content">
                        <Input type="text" v-model="searchForm.content" placeholder="行为详情" clearable style="width: 150px" />
                    </Form-item>
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getPerformanceList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
