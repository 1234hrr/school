            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="name">
                        <Input type="text" v-model="searchForm.name" placeholder="姓名" clearable style="width: 150px" />
                    </Form-item>
                    <Form-item label="" prop="level">
                        <Select v-model="searchForm.level" placeholder="年级" clearable style="width: 150px">
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getMyStudentList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
